  ...
  try {
    ...
    const followUp = (await chatJson({
      ...
      user: buildDeepenQuestionsPrompt({
        preparedHistory,
        priorFinalHistory: priorHistory,
        preparedSignalSlots: signalReasonArrayTexts(prepared.record.model.signalReasons),
        reportAnalyses: report.record.model.questionsAnalyses,
        reportSignalReasons: report.record.model.signalReasons,
        priorQuestions: flattenQuestions(priorRoundAnalyses),
        priorQa,
        recalledContext,
      }),
